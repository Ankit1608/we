      ...
      <ScrollView>
        <View style={{margin: 10, padding: 5}}>
          <Image
            ...
            source={require('./assets/searchcover.png')}
          />
        </View>
        <View>
          <Pressable style={styles.searchButton} onPress={redirect}>
            <Fontisto name="search" size={25} color={'#1e6485'} />
            <Text style={styles.searchButtonText}>Search a Place</Text>
          </Pressable>
        </View>
